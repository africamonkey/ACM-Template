...
\ding{173} 对偶问题：$\min_{w_1, w_2, \cdots, w_m} w_0 = b_1x_1 + b_2x_2 + \cdots + b_mx_m$ ，满足 $A^T_{i1}w_1 + A^T_{i2}w_2 + \cdots A^T_{im}w_m \geq c_i, 1 \leq i \leq n$ 且 $w_j \geq 0, 1 \leq j \leq m$.
